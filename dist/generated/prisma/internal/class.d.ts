 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
     ...
     * `prisma.emailDelivery`: Exposes CRUD operations for the **EmailDelivery** model.
      ...
      * ```
      */
    get emailDelivery(): Prisma.EmailDeliveryDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.applicationTeamMember`: Exposes CRUD operations for the **ApplicationTeamMember** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more ApplicationTeamMembers
      * const applicationTeamMembers = await prisma.applicationTeamMember.findMany()
      * ```
      */
    get applicationTeamMember(): Prisma.ApplicationTeamMemberDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
}
